        ...
        try {
            ...
            while (true) {
                ...
                if (opcao.equals("1")) {
                    ...
                    System.out.println(success ? "Registo efetuado!" : "Utilizador ja existe.");
            ...
            try {
                switch (args[0]) {
                    ...
                    case "upload": {
                        ...
                        String path = normalize(currentPath);
                        boolean isShared = currentPath.startsWith("/shared/");
                    ...
                    case "share": {
                        ...
                        System.out.println("[DEBUG CLI] currentPath: " + currentPath + " | nome: " + nome + " | fullPath: " + fullPath);
